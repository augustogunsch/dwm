...
static const char col_sel[]        = "#111111";
static const char col_orange[]        = "#ea811e";
static const unsigned int baralpha = 0x64;
static const unsigned int borderalpha = OPAQUE;
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_white, col_black, col_gray2 },
	[SchemeSel]  = { col_white, col_sel,  col_white  },
};
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_Print,  spawn,          SHCMD("xdotool mousemove_relative 0 1; scrot -scapture -zfo ~/shot.png") },
